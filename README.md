IsNumberDividesBy9. Python tutorials.  Algorithms. Simple Input/Output. Console Application. 
...
Answer to the question whether a given number is divisible by 9.
...
Ответ на вопрос делится ли данное число на 9.
